...
print("         Course: Python Object-Oriented Programming")
print("                             chapter 1: Object-Oriented Python")
...
class Book:
    ...
    # TODO: use the __repr method to return an obj representation
    def __repr__(self):
    ...
    # TODO: the __ge__ method establishes >= relationship with another obj
    def __ge__(self, value):
        if not isinstance(value, Book):
            raise ValueError("Cant compare book to a non-book")
        return self.price >= value.price

    # TODO: the __lt__ method establishes < relationship with another obj
...
print()
print("__str__ method: " + (str(book1)))
print("repr method: \n" + repr(book1))
print()
print("__str__ method: " + (str(book2)))
print("repr method: \n" + repr(book2))
print()
print(book1 == book3)
print(book1 == book2)
...
# Data Model - contains all the Special "Magic" Methods
...
class Book:
    ...
    def __getattribute__(self, name):
        if name == "price":
            ...
            return p - (p * d)
        return super(Book, self).__getattribute__()
